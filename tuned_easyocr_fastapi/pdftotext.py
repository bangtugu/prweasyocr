...
custom_model_dir = './tuned_model'
# reader = easyocr.Reader(['en'], model_storage_directory=custom_model_dir, download_enabled=False)

# 750일 경우
reader = Reader(['ko', 'en'], gpu=False, recog_network='finetuningmodel', download_enabled=False, user_network_directory='./user_network', model_storage_directory='./model')
# else
# ocr_reader = Reader(lang_list=['ko', 'en'], gpu=True, model_storage_directory="./tuned_model")
